...
public class JPADataManagerUnitTest {
    ...
    public void testCreateAccount() {
        ...
        Doctor doctor = Mockito.spy(new Doctor(StaffEnum.DOCTOR, "Dupont", "Patrick", "5 Avenue de la Republique", "patoche@gmail.com", "0718547896", pole, pediatrie));
        Nurse nurse = Mockito.spy(new Nurse(StaffEnum.NURSE, "Durand", "Emilie", "5 Avenue de la Republique", "emilie.durand@gmail.com", "0718547896", pole));
        ...
        UserAccount doctorAccount = Mockito.spy(new UserAccount("pseudoDoctor", "passwordDoctor", d));
        UserAccount nurseAccount = Mockito.spy(new UserAccount("pseudoNurse", "passwordNurse", n));
    ...
    public void testGetAllHospitalUnits() {
        ...
        Specialization andrologie = Mockito.spy(new Specialization(SpecializationEnum.Andrologie));
        Specialization cardiologie = Mockito.spy(new Specialization(SpecializationEnum.Cardiologie));
        Specialization neurologie = Mockito.spy(new Specialization(SpecializationEnum.Neurologie));
    ...
    public void testCreateCareUnit() {
        ...
        Specialization andrologie = Mockito.spy(new Specialization(SpecializationEnum.Andrologie));
        Specialization cardiologie = Mockito.spy(new Specialization(SpecializationEnum.Cardiologie));
        Specialization neonatologie = Mockito.spy(new Specialization(SpecializationEnum.Neonatologie));
    ...
    public void testCreateDoctor() {
        ...
        Doctor doctor = Mockito.spy(new Doctor(StaffEnum.DOCTOR, "Durand", "Emilie", "5 Avenue de la Republique", "emilie.durand@gmail.com", "0718547896", pole, pediatrie));
    ...
    public void testGetAllDoctors() {
        ...
        Doctor doctor1 = Mockito.spy(new Doctor(StaffEnum.DOCTOR, "Durand", "Emilie", "5 Avenue de la Republique", "emilie.durand@gmail.com", "0718547896", pole, pediatrie));
        Doctor doctor2 = Mockito.spy(new Doctor(StaffEnum.DOCTOR, "Dupond", "Patrick", "5 Avenue de Paris", "patoche@gmail.com", "0718548716", pole, pediatrie));
    ...
    public void testGetAllNurses() {
        ...
        Nurse nurse1 = Mockito.spy(new Nurse(StaffEnum.NURSE, "Durand", "Emilie", "5 Avenue de la Republique", "emilie.durand@gmail.com", "0718547896", pole));
        Nurse nurse2 = Mockito.spy(new Nurse(StaffEnum.NURSE, "Dupond", "Marine", "5 Avenue de la Republique", "emilie.durand@gmail.com", "0718547896", pole));
    ...
    public void testGetStaff() {
        ...
        Nurse nurse = Mockito.spy(new Nurse(StaffEnum.NURSE, "Durand", "Emilie", "5 Avenue de la Republique", "emilie.durand@gmail.com", "0718547896", pole));
        Doctor doctor = Mockito.spy(new Doctor(StaffEnum.DOCTOR, "Dupond", "Patrick", "5 Avenue de Paris", "patoche@gmail.com", "0718548716", pole, pediatrie));
