...
export class MedicalRecordsRESTEndpointService extends BaseService {
   ...
   * @param idRecord undefined
   */
   createDiagnosticResponse(idRecord: number, diagnostic: DiagnosticDTO): Observable<HttpResponse<string>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: DiagnosticDTO = diagnostic;
   ...
   * @param idRecord undefined
   */
   createDiagnostic(idRecord: number, diagnostic: DiagnosticDTO): Observable<string> {
    return this.createDiagnosticResponse(idRecord, diagnostic).pipe(
      map(_r => _r.body)
    );
  }
   ...
   * @param idRecord undefined
   */
  createResultExamResponse(idRecord: number, resultExam:ResultExamDTO): Observable<HttpResponse<string>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: ResultExamDTO = resultExam;

    let req = new HttpRequest<any>(
      "POST",
      this.rootUrl + `/records/${idRecord}/resultExam`,
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @param idRecord undefined
   */
   createResultExam(idRecord: number, resultExam:ResultExamDTO): Observable<string> {
    return this.createResultExamResponse(idRecord, resultExam).pipe(
      map(_r => _r.body)
    );
  }
   ...
   * @param idRecord undefined
   */
   createPrescriptionResponse(idRecord: number, prescription: PrescriptionDTO): Observable<HttpResponse<string>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: PrescriptionDTO = prescription;
   ...
   * @param idRecord undefined
   */
   createPrescription(idRecord: number, prescription: PrescriptionDTO): Observable<string> {
    return this.createPrescriptionResponse(idRecord, prescription).pipe(
      map(_r => _r.body)
    );
  }
